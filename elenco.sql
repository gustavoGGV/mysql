...
create table ator (
    ...
    nacAtor varchar(20) not null,
    sexoAtor char(1) not null,
    idadeAtor int(2) not null,
...
('f11', 'Iressistível Paixão', '1998', '10000000', '10'),
...
('f24', 'a1', 'Annie', '1800000'),
('f25', 'a9', 'James', '1400000'),
